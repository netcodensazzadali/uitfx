...
import BannerForAllTraders from "../../components/banners/BannerForAllTrader";
...
export default function CopyTrade() {
  ...
  return (
    <div>
      ...
      <main>
        <BannerForAllTraders></BannerForAllTraders>
        <div className="CommissionChart copy-trade-chart pb-5">
                ...
                <div className="col-xl-8 col-lg-9">
                  <div className="row">
                    {users.map((user, index) => (
                      <div
                        className="col-md-3 col-sm-4 col-12 mb-3"
                        key={index}
                      >
                        <UserCard
                          image={user.image}
              ...
              <Row>
                <Col lg={12} className="text-center">
                  <button className="text-center GlobalBtn custom my-5">
                    <Link href="https://my.uitfx.com/create-investor-account">
                      See all traders
                    </Link>
                  </button>
                </Col>
